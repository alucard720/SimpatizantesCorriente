...
export const normalizeCedula = (value) => value.replace(/[\s-]/g, "");
export const cedulaDigest = (value) => createHmac("sha256", Buffer.from(env.CEDULA_HMAC_KEY, "base64"))
...
export function decrypt(value, context) {
