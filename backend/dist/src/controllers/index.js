...
export const listRegistrations = async (req, res) => {
    res.json(await registrations.listRegistrations(req.query, req.auth, context(req)));
};
export const sensitiveData = async (req, res) => {
    res.json(await registrations.sensitiveData(req.params.id, req.body, context(req)));
};
export const updateStatus = async (req, res) => {
    res.json(await registrations.updateStatus(req.params.id, req.body, req.auth, context(req)));
};
...
export const createCatalog = (kind) => async (req, res) => {
    res
        .status(201)
